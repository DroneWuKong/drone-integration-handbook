...
(function() {{
  ...
  function doSearch(query) {{
    ...
    // Track search query
    if (window.__hbAnalytics) window.__hbAnalytics.search(query, scored.length);
