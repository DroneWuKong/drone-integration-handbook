...
DEPENDENCY_GRAPH = {
    "NVIDIA Jetson Orin NX": {
        "platforms": ["Skydio X10D", "Shield AI V-BAT", "Anduril Ghost-X", "Neousys FLYC-300", "Forecr DSBoard"],
        "programs": ["Army SRR", "USAF CCA", "Replicator/DAWG", "USSOCOM ISR"],
        "upstream": ["TSMC (fab)", "Samsung/SK Hynix (DRAM)", "NVIDIA (design)"],
        "single_source": True,
        "cascade_severity": "critical",
    },
    "Qualcomm QRB5165": {
        "platforms": ["ModalAI VOXL 2", "ModalAI Seeker", "Teal 2", "Teal Black Widow", "Qualcomm RB5"],
        "programs": ["Army SRR Tranche 2", "USMC FPV", "Drone Dominance"],
        "upstream": ["TSMC (fab)", "Qualcomm (design)", "Samsung (DRAM)"],
        "single_source": True,
        "cascade_severity": "critical",
    },
    "STM32H743": {
        "platforms": ["Neros Archer", "Orqa H7 FC", "Pixhawk 6X", "~100+ FCs in Forge DB"],
        "programs": ["Drone Dominance", "USMC FPV", "Ukraine FPV production", "Commercial FPV"],
        "upstream": ["STMicroelectronics (EU fab)", "GlobalFoundries"],
        "single_source": False,
        "cascade_severity": "high",
    },
    "FLIR Boson 640": {
        "platforms": ["Switchblade 600", "Anduril Ghost-X", "Teal 2 (Hadron)"],
        "programs": ["Ukraine USAI", "USSOCOM", "Replicator"],
        "upstream": ["Teledyne FLIR (sole manufacturer)"],
        "single_source": True,
        "cascade_severity": "high",
    },
    "Doodle Labs Helix": {
        "platforms": ["Anduril Ghost-X", "Multiple Blue UAS integrators"],
        "programs": ["Lattice Mesh", "Replicator", "SOF MANET"],
        "upstream": ["Qualcomm/Atheros (WiFi silicon)", "Doodle Labs (firmware/assembly)"],
        "single_source": True,
        "cascade_severity": "high",
    },
    "ELRS 900MHz": {
        "platforms": ["Neros Archer", "Ukraine FPV fleet", "Commercial FPV"],
        "programs": ["Drone Dominance", "USMC FPV", "Ukraine defense"],
        "upstream": ["Semtech SX1276/SX1262 (LoRa chip)", "Espressif ESP32"],
        "single_source": False,
