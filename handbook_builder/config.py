...
CHAPTERS: Final[tuple[ChapterSpec, ...]] = (
    ...
    ChapterSpec("field/ew-countermeasures.md", 38, "RF Interference Recognition & Flight Safety"),
    ...
    ChapterSpec("field/elint-operators.md", 42, "Lawful Spectrum Survey for UAS Operations"),
...
PARTS: Final[tuple[PartSpec, ...]] = (
    ...
    PartSpec(
        "advanced-field",
        "Field Guides — Resilient & Austere Operations",
        (38, 39, 40, 41, 42),
        "Reviewed references for interference safety, fiber systems, publication holds, production, and lawful spectrum coordination.",
    ),
    PartSpec(
        "integration",
        "Part 4 — Integration",
