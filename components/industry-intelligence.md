...
>
> **Live dashboard with filtering:** [uas-patterns.com/intel/](/intel/)
...
| Source | URL | Coverage |
|--------|-----|----------|
| **GetFPV** | [getfpv.com](https://www.getfpv.com) | Largest FPV parts retailer. 2,700+ product links in Forge. NDAA section. |
| **RaceDayQuads** | [racedayquads.com](https://www.racedayquads.com) | FPV specialist. Fast shipping. Good stock on motors and frames. |
| **Drone Syndicate Store** | [syndicate.uasnexus.com](https://syndicate.uasnexus.com) | UAS Nexus curated marketplace. NDAA/Blue UAS components focus. |
| **SpeedyBee FPV** | [speedybee.com](https://www.speedybee.com) | SpeedyBee ecosystem + accessories. Bluetooth configurator. |
| **vtx.in.ua** | [vtx.in.ua](https://vtx.in.ua) | Ukrainian FPV shop. Combat-tested components. UAH + USD pricing. |

### Key Manufacturers (NDAA Compliant)

| Manufacturer | URL | Products | Notes |
|-------------|-----|----------|-------|
| **ModalAI** | [modalai.com](https://www.modalai.com) | VOXL2 companion computer, Seeker/Stinger drones | 16 Blue UAS listings. Qualcomm SoC. |
| **ARK Electronics** | [arkelectron.com](https://arkelectron.com) | Pixhawk FMUv6X flight controllers | Blue UAS Framework. US-made. |
| **Lumenier** | [lumenier.com](https://www.lumenier.com) | Motors, FCs, batteries, frames | NDAA compliant. GetFPV house brand. |
| **Orqa** | [orqafpv.com](https://orqafpv.com) | QuadCore H7 FC, FPV goggles | Croatian. NDAA compliant. |
| **Persistent Systems** | [persistentsystems.com](https://persistentsystems.com) | MPU5 MANET mesh radios | Military-grade. Wave Relay. |
| **Silvus Technologies** | [silvustechnologies.com](https://silvustechnologies.com) | StreamCaster mesh radios | MIL-STD. Defense standard. |
| **Doodle Labs** | [doodlelabs.com](https://doodlelabs.com) | Helix mesh radios | Compact. Blue UAS Framework. |
| **Inertial Labs** | [inertiallabs.com](https://inertiallabs.com) | INS, AHRS, GNSS receivers | US-made. Survey/mapping grade. |
| **Ouster** | [ouster.com](https://ouster.com) | Digital LiDAR sensors | NDAA compliant. OS series. |
| **Obsidian Sensors** | [obsidiansensors.com](https://obsidiansensors.com) | Miramar MVF thermal cameras | Qualcomm spin-out. LAMP on glass. |

### Key Manufacturers (International)

| Manufacturer | URL | Country | Products |
|-------------|-----|---------|----------|
| **T-Motor** | [store.tmotor.com](https://store.tmotor.com) | China | Premium motors, ESCs, props |
| **EMAX** | [emaxmodel.com](https://emaxmodel.com) | China | ECO/Eco II motors |
| **Foxeer** | [foxeer.com](https://foxeer.com) | China | FPV cameras, VTX |
| **Caddx** | [caddxfpv.com](https://caddxfpv.com) | China | Walksnail Avatar, analog cameras |
| **HDZero** | [hdzero.com](https://hdzero.com) | China | Digital FPV system |
| **BetaFPV** | [betafpv.com](https://betafpv.com) | China | Micro/whoop drones + parts |
...
The Defense Innovation Unit (DIU) maintains the [Blue UAS](https://www.diu.mil/blue-uas) Cleared List of platforms approved for DoD purchase without exception-to-policy requests.
...
*Full list: [diu.mil/blue-uas](https://www.diu.mil/blue-uas)*
...
*Live dashboard: [uas-patterns.com/intel/](/intel/)*
