...
> **NDAA Status:** NDAA §848 compliant, Blue UAS listed
...
6. **Blue UAS listed** — verifiable DoD procurement path, which distinguishes it from most MOSA FPV builds.
